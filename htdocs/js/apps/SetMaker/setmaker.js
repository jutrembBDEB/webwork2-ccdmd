...
function lib_update(who, what ) {
  ...
  if(who == 'count') {
    ...
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('398 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
  ...
  // console.log(mydefaultRequestObject);
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('431 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
}
function blib_update(who, what) {
  ...
  if(who == 'count') {
    ...
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('493 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
  ...
  // console.log(mydefaultRequestObject);
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('526 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
}
function benlib_update(who, what) {
  ...
  if(who == 'count') {
    ...
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('588 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
  ...
  // console.log(mydefaultRequestObject);
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('621 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
}
function dir_update(who, what ) {
  ...
  if(who == 'count') {
    ...
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('702 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
  ...
  // console.log(mydefaultRequestObject);
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('744 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
}
function lib_searchops() {
  ...
  // console.log(mydefaultRequestObject);
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('792 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
}
function enlib_searchops() {
  ...
  // console.log(mydefaultRequestObject);
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('843 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
}
  ...
  mydefaultRequestObject.command = subcommand;
   console.log(mydefaultRequestObject);
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('924 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
}
  ...
  mydefaultRequestObject.command = subcommand;
   console.log(mydefaultRequestObject);
    return $.ajax({type:'post',
		  ...
		  error: function (data) {
		      alert('973 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		  },
		  });
}
...
function addemcallback(wsURL, ro, probarray, count) {
  ...
  return function (data) {
      return $.ajax({type:'post',
		     ...
		     error: function (data) {
			 alert('1117 setmaker.js: '+wsURL+': '+data.statusText);
		     },
		    });
...
function markinset() {
  ...
  ro.command = 'true';
    return $.ajax({type:'post',
		   ...
		   error: function (data) {
		       alert('1163 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
		   },
		  });
}
...
function findAPLindex(path) {
  ...
  if(j==1000) { alert('1228 setmaker.js: '+"Cannot find " +path);}
  return j;
}
...
function randomize(filepath, el) {
  ...
  $.ajax({type:'post',
	  ...
	  error: function (data) {
	      alert('1292 setmaker.js: '+basicWebserviceURL+': '+data.statusText);
	  },
	 });
