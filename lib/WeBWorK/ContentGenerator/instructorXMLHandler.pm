...
#		    pw                      => $r->param('pw') ||undef,
		    ...
		    library_lib	    => $r->param("library_lib") ||undef,
		    library_dir	    => $r->param("library_dir") ||undef,
		    library_subdir	    => $r->param("library_subdir") ||undef,
		    library_topdir	    => $r->param("library_topdir") ||undef,
		    ...
		    benlibrary_subjects    => $r->param("benlibrary_subjects") ||undef,
		    benlibrary_chapters    => $r->param("benlibrary_chapters") ||undef,
		    ...
		    library_defkeywords     => $r->param("library_defkeywords") ||undef,
		    source			        =>  '',
